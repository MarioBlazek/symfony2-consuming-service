...
class GuzzleRequestHandlerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('AppBundle\RequestHandler\Middleware\GuzzleRequestHandler');
    }
    ...
    function it_uses_guzzle_to_do_the_actual_request(ClientInterface $client, RequestInterface $guzzleRequest, ResponseInterface $guzzleResponse, StreamInterface $stream)
    {
