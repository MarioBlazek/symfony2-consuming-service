...
class EventRequestHandlerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('AppBundle\RequestHandler\Middleware\EventRequestHandler');
    }
    ...
    function it_dispatches_events(EventDispatcherInterface $eventDispatcher, Request $request, RequestHandler $requestHandler, Response $response)
    {
